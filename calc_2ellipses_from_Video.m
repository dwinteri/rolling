...
save('AngleDif');%save data obtained from the subrstraction of the angle between the 2 ellipses




% To calculate the angle you can stop here

%% Plot angle delta and motor angle vs time stamp (just to check)
...
%% Make an image sequence to show 2 ellipse
figure %open a new figure
for i = 1 :10:100
    im = read (v,i);
%     imgray = rgb2gray(im);
...
%% Binarize, get and draw 2 ellipses on one single frame
